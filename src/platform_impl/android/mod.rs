...
use ndk::looper::{ForeignLooper, Poll, ThreadLooper};
...
impl Window {
    ...
    pub fn inner_position(&self) -> Result<PhysicalPosition<i32>, Error> {
        Err(make_error!(ErrorType::NotSupported(
            "inner_position is not supported on android".into()
        )))
    }

    pub fn outer_position(&self) -> Result<PhysicalPosition<i32>, Error> {
        Err(make_error!(ErrorType::NotSupported(
            "outer_position is not supported on android".into()
        )))
    }
    ...
    pub fn set_fullscreen(&self, _monitor: Option<window::Fullscreen>) -> Result<(), Error> {
        Err(make_error!(ErrorType::NotSupported(
            "set_fullscreen is not supported on android".into()
        )))
    }
    ...
    pub fn set_cursor_position(&self, _: Position) -> Result<(), Error> {
        Err(make_error!(ErrorType::NotSupported(
            "set_cursor_position is not supported on android".into()
        )))
    }

    pub fn set_cursor_grab(&self, _: bool) -> Result<(), Error> {
        Err(make_error!(ErrorType::NotSupported(
            "set_cursor_grab is not supported on android".into()
        )))
    }
